...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key helm-find-files-map (kbd "S-<tab>") 'helm-select-action)
#+END_SRC
...
#+RESULTS:
| (lambda nil Beautify Org Checkbox Symbol (setq prettify-symbols-alist (cons (quote ([ ] . ☐)) prettify-symbols-alist)) (setq prettify-symbols-alist (cons (quote ([X] . ☑)) prettify-symbols-alist)) (setq prettify-symbols-alist (cons (quote ([-] . ❍)) prettify-symbols-alist)) (prettify-symbols-mode)) | (lambda nil (org-bullets-mode)) | (lambda nil (visual-line-mode 1)) | org-indent-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-block-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes |
